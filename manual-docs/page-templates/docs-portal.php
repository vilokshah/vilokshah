 ...
 * Description: DigiDocs-style homepage with search, release versions, and categories.
 *
 * @package ManualDocs
 */
...
$start_url  = function_exists( 'manual_docs_get_docs_entry_url' ) ? manual_docs_get_docs_entry_url() : home_url( '/' );
?>
